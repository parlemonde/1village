    ...
    <div className={styles.mapContainer}>
      ...
      <div className={styles.legendContainer}>
        ...
        <ul>
          ...
          <li>
            <div style={{ verticalAlign: 'middle', display: 'inline' }}>
              <CircleIcon fontSize="small" sx={{ color: EngagementStatusColor.ABSENT, verticalAlign: 'middle' }} /> <span>Absent</span>: la majorité
              des classes ne se sont jamais connectées
            </div>
          </li>
        </ul>
      </div>
