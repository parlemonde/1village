            ...
            village.countries.map((country: Country) => (
              <Flag
                ...
                isMistery={
                  !village ||
                  !user ||
                  (selectedPhase === 1 && user.country.isoCode.toUpperCase() !== country.isoCode && isObservator && !isModerateur) ||
                  (user.firstLogin < 2 && user.country.isoCode.toUpperCase() !== country.isoCode && isObservator && !isModerateur)
                }
              ></Flag>
            ))}
        </div>
