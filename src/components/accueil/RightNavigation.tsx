      ...
      >
        <div style={{ display: 'flex', flexDirection: 'row', alignItems: 'center', minWidth: 0 }}>
          <span style={{ marginRight: '0.3rem', display: 'flex' }}>
            <AvatarImg user={activityUser} size="extra-small" noLink displayAsUser={displayAsUser} onClick={onclick} style={{ cursor: 'pointer' }} />
          </span>
          <span className="text">
        ...
        <div style={{ display: 'flex', flexDirection: 'row', alignItems: 'center', minWidth: 0 }}>
          <span style={{ marginRight: '0.3rem', display: 'flex' }}>
            {activityUser.avatar ? (
              ...
              <Tooltip title="la classe n'a pas encore de mascotte" style={{ cursor: 'not-allowed' }}>
