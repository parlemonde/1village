...
describe('Phase matching test', () => {
  describe('for Presentation', () => {
    describe('for active Phase 1', () => {
      const activePhase = 1;
      it('should return phase 1 if selectedPhase is 1', () => {
        const selectedPhase = 1;
        expect(getActivityPhase(ActivityType.PRESENTATION, activePhase, selectedPhase)).toEqual(selectedPhase);
      });
      it('should return phase 1 if selectedPhase is 2', () => {
        const selectedPhase = 2;
        expect(getActivityPhase(ActivityType.PRESENTATION, activePhase, selectedPhase)).toEqual(activePhase);
      });
