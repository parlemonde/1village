    ...
    <Base>
      <div style={{ width: '100%', padding: '0.5rem 1rem 1rem 1rem' }}>
        ...
        <div style={{lineHeight:"70px"}}>
            ...
            <span>Nous sommes </span> <TextField style={{ display:"inline"}} type="number" /> <span> élèves, dont </span> <TextField style={{display:"inline"}} type="number"/> <span> filles et </span> <TextField style={{display:"inline"}} type="number"/> <span> garçons.</span><br/>
            <span>En moyenne, l’âge des élèves de notre classe est </span> <TextField style={{display:"inline"}} type="number"/> <span> ans.</span><br/>
            <span>Nous avons </span> <TextField style={{display:"inline"}} type="number"/> <span> professeurs, dont </span> <TextField style={{display:"inline"}} type="number"/> <span> femmes et </span> <TextField style={{display:"inline"}} type="number"/> <span> hommes.</span> <br/>
            <span>Dans notre école, il y a </span> <TextField style={{display:"inline"}} type="number"/> <span> classes et </span> <TextField style={{display:"inline"}} type="number"/> <span> élèves.</span>
