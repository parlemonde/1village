...
import { ENIGME_TYPES, getEnigmeTimeLeft } from 'src/activities/enigme.const';
      ...
      {!isAnswer && (
        <div style={{ width: '100%', textAlign: 'right' }}>
          <Link href={`/activite/${activity.id}?reponse=true`}>
            <Button disabled={timeLeft > 0} color="primary" variant="outlined" component="a" href={`/activite/${activity.id}?reponse=true`}>
