    ...
    <Base>
      <PageLayout>
        ...
        <div className="width-900">
          <h1>Choisissez un Objectif du Développement Durable selon l’image</h1>
          <p className="text">Pour atteindre votre odd, vous imaginerez un objet et un lieu aux étapes suivantes.</p>
          <Grid container>
