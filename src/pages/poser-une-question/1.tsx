    ...
    <Base>
      <PageLayout>
        ...
        <div className="width-900">
          ...
          <p className="text">
            Vous trouverez ici les questions qui ont été posées par les pélicopains. Si vous vous posez la même question que certains, vous pouvez
            cliquer sur “Je me pose la même question”.
          </p>
