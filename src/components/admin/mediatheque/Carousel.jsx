...
export const MediaCarousel = ({ items }) => {
  ...
  return (
    <div style={{ position: 'relative', maxWidth: '100%', overflow: 'hidden' }}>
      ...
      <Button style={{ position: 'absolute', top: '50%', left: 0, transform: 'translateY(-50%)' }} onClick={goToPrevSlide}>
        <NavigateBeforeIcon />
      </Button>
      <Button style={{ position: 'absolute', top: '50%', right: 0, transform: 'translateY(-50%)' }} onClick={goToNextSlide}>
        <NavigateNextIcon />
      </Button>
    </div>
  );
