          ...
          inputs: [
            {
              ...
              selectedValue: 'maternelle chez tous les élèves',
              required: true,
            },
          ],
        },
          ...
          inputs: [
            {
              ...
              type: InputTypeEnum.IMAGE,
              selectedValue:
                'https://media.istockphoto.com/id/868646936/fr/vectoriel/ic%C3%B4ne-de-pingouin-mignon-dans-le-plat-style.jpg?s=612x612&w=0&k=20&c=0m-B3EHR1qhEj3b3STu1AqteaOXvlw7_z8V6LdsTClY=',
              isDisplayedInRecap: true,
              required: true,
            },
            {
