...
const Communication = () => {
  ...
  const [textValue, setTextValue] = useState(
    ...
    <li>Connectez-vous sur https://1v.parlemonde.org/connexion et rattachez votre compte à l’identifiant unique <strong>%identifiant</strong></li>
    </ol>
