...
import { TextField, Button, Card, CircularProgress, FormControl, FormControlLabel, Radio, RadioGroup } from '@mui/material';
...
const ClassroomParamStep1 = () => {
  ...
  // const debouncedhandleRadioSelect = (newState: StateType) => {
  //   debounce(() => {
  //     console.log('VALUE dans debounced');
                ...
                <FormControlLabel
                  ...
                  label={
                    <TextnInputContainer
                      ...
                      onChange={(event) => {
                        handleDaysDelay('timeDelay', event);
                        //debouncedhandleRadioSelect(event);
                      }}
