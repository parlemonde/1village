...
const MimiqueStep3: React.FC = () => {
  ...
  const isValid = () => {
    return (
      data.mimique3.origine != null &&
      data.mimique3.signification != null &&
      data.mimique3.fakeSignification1 != null &&
      data.mimique3.fakeSignification2 != null //&&
      //data.mimique3.video != null
    );
  };
      ...
      <div style={{ width: '100%', padding: '0.5rem 1rem 1rem 1rem' }}>
        ...
        <div className="width-900">
          ...
          <Grid container spacing={3}>
            ...
            <Grid item xs={12} md={8}>
              ...
              <TextField
                ...
                error={isError && data.mimique3.signification == null}
                helperText={isError && data.mimique3.signification == null ? 'Ce champ est obligatoire' : ''}
              />
              ...
              <TextField
                ...
                style={{ width: '100%', margin: '10px' }}
                error={isError && data.mimique3.origine == null}
                helperText={isError && data.mimique3.origine == null ? 'Ce champ est obligatoire' : ''}
              />
            </Grid>
          </Grid>
          <h1>Présentez en vidéo une 3ème mimique à vos Pélicopains</h1>
          ...
          <TextField
            ...
            style={{ width: '100%', margin: '10px' }}
            error={isError && data.mimique3.fakeSignification1 == null}
            helperText={isError && data.mimique3.fakeSignification1 == null ? 'Ce champ est obligatoire' : ''}
          />
          <TextField
            variant="outlined"
            ...
            style={{ width: '100%', margin: '10px' }}
            error={isError && data.mimique3.fakeSignification2 == null}
            helperText={isError && data.mimique3.fakeSignification2 == null ? 'Ce champ est obligatoire' : ''}
          />
